...
from pagerank import domainrange_pagerank
...
def run_replace(model, tm, emap, rmap, original_hrt, test_hrt, n_iters):
    ...
    _, it0 = domainrange_pagerank(build_graph(original_hrt, emap, rmap))
    ...
    for it in range(1, n_iters + 1):
        ...
        pr, pr_iters = domainrange_pagerank(build_graph(all_graph, emap, rmap))
